...
export const Header = props => {
    ...
    return (
        <div id="header" style={{ width: "100%", height: "15%", boxSizing: "border-box", margin: 0, padding: 18, display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", backgroundColor: " #262424" }}>
            <div style={{ width: 100, height: 100, backgroundColor: "white", borderRadius: 54, overflow: "hidden", borderWidth: 4, borderStyle: "solid", borderColor: "#ffcb00", backgroundColor: " #262424" }}>
