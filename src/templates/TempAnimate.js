...
//                 <h1 style={{ fontFamily: "Montserrat", color: "#999", textAlign: "center", fontSize: 70, display: "flex", justifyContent: "center", marginTop: 8, marginLeft: 2 }}>{props.firstName[0]}</h1>
//             </div>
...
//                 <div style={{ textAlign: "left", paddingLeft: 3, marginBottom: 5, fontsize: 13, color: "#eee", fontWeight: 400, fontFamily: "sans-serif", color: "white", letterSpacing: 5 }}>Software Engineer</div>
